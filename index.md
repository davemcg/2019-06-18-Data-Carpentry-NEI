...
venue: "NIH Building 10 FAES Room 4 - B1C205"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 4 - B1C205, 10 Center Drive, Building 10, Bethesda, MD 20892"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["David McGaughey","Matthew Brooks"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper:    ["Vinay Swamy"] # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["mcgaugheyd@mail.nih.gov", "brooksma@nei.nih.gov"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-06-18-NEI-DC          # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
the pitch.
{% endcomment %}
<strong>Registration:</strong> First priority will be given to NEI staff. If there are any available spots within a week of the workshop starting, then the NIH community will get the remaining spots. Please fill out <a href = "https://forms.gle/5dDoMHZf5TDqpR9x7">this form</a> to register. 
